...
- Registers a scheduled task that runs as SYSTEM and checks the radio at logon, at startup, and right after resuming from sleep. If it is stuck in an error state, it removes and rescans the device automatically. No more clicking through Device Manager.
